...
{
    public const string HotfixScriptTemplate = "Assets/GameRes/Configs/HotfixScriptTemplate.txt";
    public const string MainScriptTemplate = "Assets/GameRes/Configs/MainScriptTemplate.txt";
