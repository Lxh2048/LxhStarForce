...
namespace GameFrame.Main
{
    public class ProcedureLaunch : ProcedureBase
    {
        ...
        protected override void OnEnter(ProcedureOwner procedureOwner)
        {
            ...
            // 构建信息：发布版本时，把一些数据以 Json 的格式写入 Assets/GameRes/Configs/BuildInfo.txt，供游戏逻辑读取
            ...
            // 默认字典：加载默认字典文件 Assets/GameRes/Configs/DefaultDictionary.xml
    ...
    public static class ProcedureSoundExtension
    {
